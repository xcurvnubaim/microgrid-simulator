...
| Served load energy | 6,504.900 | kWh | model output |
...
| PV used | 22.179 | kWh | before source attribution |
| PV curtailed/spilled | 3,932.941 | kWh | PV-only waste definition |
| Diesel generation | 11,547.574 | kWh | assumed generator model |
| Diesel load-serving energy | 6,482.721 | kWh | PV-first accounting attribution |
| Diesel overgeneration | 4,830.489 | kWh | diesel share routed to the dump-load path |
| Diesel useful output | 58.169 | % | generation not classified as dumped diesel excess |
...
| Excess generation | 4,830.489 | kWh | non-load-serving generation |
| Dump-load energy | 4,830.489 | kWh | explicit sink for non-exportable surplus |
| Network losses | 68.188 | kWh | separate from excess generation |
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 2026-03-13 | 2,270.800 | 100.000 | 0.000 | 22.179 | 3,848.799 | 234.365 | 2,694.159 | 95.000 |
| 2 | 2026-03-14 | 2,310.200 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
| 3 | 2026-03-15 | 1,923.900 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
...
```bash
uv run microgrid-sim replay --config /home/ma012/projects/microgrid-simulator/configs/economic-e3-high-fuel-low-battery-use.yaml --output-dir /home/ma012/projects/microgrid-simulator/reports/experiments/comparison_matrix/E3/schedule/2026-03-13_00-00-00 --policy schedule
```
