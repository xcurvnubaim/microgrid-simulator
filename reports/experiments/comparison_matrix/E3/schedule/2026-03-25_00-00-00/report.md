...
| Served load energy | 7,938.400 | kWh | model output |
...
| PV used | 101.808 | kWh | before source attribution |
| PV curtailed/spilled | 1,382.382 | kWh | PV-only waste definition |
| Diesel generation | 11,547.574 | kWh | assumed generator model |
| Diesel load-serving energy | 7,836.592 | kWh | PV-first accounting attribution |
| Diesel overgeneration | 3,476.618 | kWh | diesel share routed to the dump-load path |
| Diesel useful output | 69.893 | % | generation not classified as dumped diesel excess |
...
| Excess generation | 3,476.618 | kWh | non-load-serving generation |
| Dump-load energy | 3,476.618 | kWh | explicit sink for non-exportable surplus |
| Network losses | 102.249 | kWh | separate from excess generation |
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 2026-03-25 | 2,553.700 | 100.000 | 0.000 | 101.808 | 3,848.799 | 234.365 | 2,694.159 | 95.000 |
| 2 | 2026-03-26 | 2,885.200 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
| 3 | 2026-03-27 | 2,499.500 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
...
| `penalty_excess` | 3,476.617919 |
| `penalty_fuel` | 56,580.357294 |
| `penalty_health` | 0.099346 |
| `penalty_unserved` | 0.000000 |
| `penalty_waste` | 1,382.382246 |
...
```bash
uv run microgrid-sim replay --config /home/ma012/projects/microgrid-simulator/configs/economic-e3-high-fuel-low-battery-use.yaml --output-dir /home/ma012/projects/microgrid-simulator/reports/experiments/comparison_matrix/E3/schedule/2026-03-25_00-00-00 --policy schedule
```
