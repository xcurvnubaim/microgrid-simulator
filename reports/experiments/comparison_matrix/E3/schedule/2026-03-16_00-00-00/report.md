...
| Served load energy | 7,728.900 | kWh | model output |
...
| PV used | 45.779 | kWh | before source attribution |
| PV curtailed/spilled | 3,317.422 | kWh | PV-only waste definition |
| Diesel generation | 11,547.574 | kWh | assumed generator model |
| Diesel load-serving energy | 7,683.121 | kWh | PV-first accounting attribution |
| Diesel overgeneration | 3,630.089 | kWh | diesel share routed to the dump-load path |
| Diesel useful output | 68.564 | % | generation not classified as dumped diesel excess |
...
| Excess generation | 3,630.089 | kWh | non-load-serving generation |
| Dump-load energy | 3,630.089 | kWh | explicit sink for non-exportable surplus |
| Network losses | 94.978 | kWh | separate from excess generation |
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 2026-03-16 | 2,400.100 | 100.000 | 0.000 | 45.779 | 3,848.799 | 234.365 | 2,694.159 | 95.000 |
| 2 | 2026-03-17 | 2,754.000 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
| 3 | 2026-03-18 | 2,574.800 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
...
```bash
uv run microgrid-sim replay --config /home/ma012/projects/microgrid-simulator/configs/economic-e3-high-fuel-low-battery-use.yaml --output-dir /home/ma012/projects/microgrid-simulator/reports/experiments/comparison_matrix/E3/schedule/2026-03-16_00-00-00 --policy schedule
```
