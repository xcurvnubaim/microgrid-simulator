...
| Served load energy | 7,700.100 | kWh | model output |
...
| PV used | 25.720 | kWh | before source attribution |
| PV curtailed/spilled | 1,833.863 | kWh | PV-only waste definition |
| Diesel generation | 11,547.574 | kWh | assumed generator model |
| Diesel load-serving energy | 7,674.380 | kWh | PV-first accounting attribution |
| Diesel overgeneration | 3,638.830 | kWh | diesel share routed to the dump-load path |
| Diesel useful output | 68.488 | % | generation not classified as dumped diesel excess |
...
| Excess generation | 3,638.830 | kWh | non-load-serving generation |
| Dump-load energy | 3,638.830 | kWh | explicit sink for non-exportable surplus |
| Network losses | 92.873 | kWh | separate from excess generation |
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 2026-03-10 | 2,712.800 | 100.000 | 0.000 | 25.720 | 3,848.799 | 234.365 | 2,694.159 | 95.000 |
| 2 | 2026-03-11 | 2,362.600 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
| 3 | 2026-03-12 | 2,624.700 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
...
| `penalty_excess` | 3,638.830276 |
| `penalty_fuel` | 56,580.357294 |
| `penalty_health` | 0.099208 |
| `penalty_unserved` | 0.000000 |
| `penalty_waste` | 1,833.863335 |
...
```bash
uv run microgrid-sim replay --config /home/ma012/projects/microgrid-simulator/configs/economic-e3-high-fuel-low-battery-use.yaml --output-dir /home/ma012/projects/microgrid-simulator/reports/experiments/comparison_matrix/E3/schedule/2026-03-10_00-00-00 --policy schedule
```
