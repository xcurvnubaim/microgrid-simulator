...
| Served load energy | 6,625.300 | kWh | model output |
...
| PV used | 104.444 | kWh | before source attribution |
| PV curtailed/spilled | 790.824 | kWh | PV-only waste definition |
| Diesel generation | 11,547.574 | kWh | assumed generator model |
| Diesel load-serving energy | 6,520.856 | kWh | PV-first accounting attribution |
| Diesel overgeneration | 4,792.354 | kWh | diesel share routed to the dump-load path |
| Diesel useful output | 58.499 | % | generation not classified as dumped diesel excess |
...
| Excess generation | 4,792.354 | kWh | non-load-serving generation |
| Dump-load energy | 4,792.354 | kWh | explicit sink for non-exportable surplus |
| Network losses | 73.856 | kWh | separate from excess generation |
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 2026-03-07 | 2,788.500 | 100.000 | 0.000 | 104.444 | 3,848.799 | 234.365 | 2,694.159 | 95.000 |
| 2 | 2026-03-08 | 1,503.900 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
| 3 | 2026-03-09 | 2,332.900 | 100.000 | 0.000 | 0.000 | 3,849.388 | 0.000 | 2,694.571 | 95.000 |
...
| `penalty_excess` | 4,792.353603 |
| `penalty_fuel` | 56,580.357294 |
| `penalty_health` | 0.099337 |
| `penalty_unserved` | 0.000000 |
| `penalty_waste` | 790.824037 |
...
```bash
uv run microgrid-sim replay --config /home/ma012/projects/microgrid-simulator/configs/economic-e3-high-fuel-low-battery-use.yaml --output-dir /home/ma012/projects/microgrid-simulator/reports/experiments/comparison_matrix/E3/schedule/2026-03-07_00-00-00 --policy schedule
```
