...
| Served load energy | 6,884.944 | kWh | model output |
| Load served | 89.414 | % | headline reliability |
| Unserved energy | 815.156 | kWh | headline failure metric |
| Blackout/brownout duration | 29.500 | h | 15-min intervals with unserved load |
| Peak unserved power | 118.686 | kW | maximum interval |
| Measured PV available | 1,859.584 | kWh | negative standby clipped to zero |
| PV used | 1,467.543 | kWh | before source attribution |
| PV curtailed/spilled | 392.041 | kWh | PV-only waste definition |
| Diesel generation | 5,393.724 | kWh | assumed generator model |
| Diesel load-serving energy | 4,800.966 | kWh | PV-first accounting attribution |
| Diesel overgeneration | 84.853 | kWh | diesel share routed to the dump-load path |
| Diesel useful output | 98.427 | % | generation not classified as dumped diesel excess |
| Diesel runtime | 52.750 | h | realized on-state |
| Diesel starts | 6.000 | count | realized starts |
| Diesel carbon proxy | 3,775.607 | kg CO2e | 0.70 kg/kWh assumed |
| Battery charge energy | 535.139 | kWh | AC-side terminal energy |
...
| Battery charge from diesel | 507.905 | kWh | surplus-diesel share of charging |
| Battery discharge energy | 643.669 | kWh | AC-side terminal energy |
| Battery throughput | 1,178.808 | kWh | charge + discharge |
| Final SOC | 18.645 | % | assumed 500 kWh battery |
| SoH loss proxy | 0.048 | percentage points | placeholder degradation law |
| Excess generation | 84.853 | kWh | non-load-serving generation |
| Dump-load energy | 84.853 | kWh | explicit sink for non-exportable surplus |
| Network losses | 83.789 | kWh | separate from excess generation |
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 2026-03-10 | 2,712.800 | 90.097 | 268.649 | 66.904 | 2,379.667 | 310.796 | 1,665.767 | 47.303 |
| 2 | 2026-03-11 | 2,362.600 | 98.312 | 39.881 | 774.287 | 1,542.065 | 463.055 | 1,079.445 | 31.507 |
| 3 | 2026-03-12 | 2,624.700 | 80.698 | 506.626 | 626.352 | 1,471.992 | 404.958 | 1,030.395 | 18.645 |
...
| `penalty_carbon` | 15,102.427931 |
| `penalty_constraint` | 31.355239 |
| `penalty_excess` | 84.853229 |
| `penalty_fuel` | 28,873.876452 |
| `penalty_health` | 2.415519 |
| `penalty_unserved` | 16,303.121273 |
| `penalty_waste` | 392.040550 |
...
```bash
uv run microgrid-sim replay --config /home/ma012/projects/microgrid-simulator/configs/economic-e1-high-diesel-fuel.yaml --output-dir /home/ma012/projects/microgrid-simulator/reports/experiments/comparison_matrix/E1/mpc/2026-03-10_00-00-00 --policy mpc
```
