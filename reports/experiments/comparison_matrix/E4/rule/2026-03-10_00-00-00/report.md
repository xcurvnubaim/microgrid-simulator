...
```bash
uv run microgrid-sim replay --config /home/xcurv/teep-taiwan/microgrid-simulator/configs/economic-e4-high-pv-waste.yaml --output-dir /home/xcurv/teep-taiwan/microgrid-simulator/reports/experiments/comparison_matrix/E4/rule/2026-03-10_00-00-00 --policy rule
```
