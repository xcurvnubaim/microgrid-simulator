...
| `penalty_fuel` | 11,612.830137 |
| `penalty_health` | 1.329401 |
| `penalty_unserved` | 1,295.256537 |
| `penalty_waste` | 2,059.178537 |
...
```bash
uv run microgrid-sim replay --config /home/xcurv/teep-taiwan/microgrid-simulator/configs/economic-e4-high-pv-waste.yaml --output-dir /home/xcurv/teep-taiwan/microgrid-simulator/reports/experiments/comparison_matrix/E4/rule/2026-03-13_00-00-00 --policy rule
```
